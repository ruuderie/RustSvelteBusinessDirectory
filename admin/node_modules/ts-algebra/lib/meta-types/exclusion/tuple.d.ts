import type { And, DoesExtend, If, Not, Tail } from "ts-algebra/lib/utils";
...
import type { $Tuple, IsTupleOpen, Tuple, TupleOpenProps, TupleType, TupleValues } from "ts-algebra/lib/meta-types/tuple";
